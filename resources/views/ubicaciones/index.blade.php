...
@section('title', 'Ubicaciones - COPAFIcne')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <button class="btn btn-primary float-right" data-toggle="modal" data-target="#createModal">
                    <i class="fas fa-plus mr-1"></i> Nueva Ubicación
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body p-0">
                @include('ubicaciones.partials.table')
            </div>
        </div>
        @include('ubicaciones.partials.modal-create')
        @include('ubicaciones.partials.modal-edit')
    </div>
@stop
